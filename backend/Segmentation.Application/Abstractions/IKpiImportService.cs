...
public interface IKpiImportService
{
    ...
    Task<KpiImportResultDto> ImportYieldAsync(Stream csvStream, CancellationToken cancellationToken = default);
    Task<KpiImportResultDto> ImportScaleAsync(Stream csvStream, CancellationToken cancellationToken = default);
